    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <!--Akhir sidebar coba-->
              ...
              <a href="<?php echo base_url() ?>index.php/laporan" class="list-group-item"><i class="fa fa-money"></i> Laporan Penjualan</a>
              <a href="<?php echo base_url() ?>index.php/laporan_pembelian" class="list-group-item"><i class="fa fa-circle"></i> Laporan Pembelian</a>
              <a href="<?php echo base_url() ?>index.php/laporan_stok" class="list-group-item"><i class="fa fa-bank"></i> Laporan Stok pulsa</a>
              <a href="<?php echo base_url() ?>index.php/laporan_profit" class="list-group-item"><i class="fa fa-paypal"></i> Laporan Profit</a>
