...
public class belipulsa extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(v == buttonView){
            startActivity(new Intent(this,TampilDataSemua.class));
        }

    }
    public void Lihat (View view) {
        Intent intent = new Intent(belipulsa.this, TampilDataSemua.class);
